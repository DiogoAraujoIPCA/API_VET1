...
namespace MyWebApi.Controllers
{
    public class PessoaController : Controller
    {
        ...
        {
            if (HelperController.Helper.AtualizarDadoPessoa(nome, numeroTelemovel, "Nome"))
            {
        ...
        public IActionResult AtualizarMorada(string morada, int numeroTelemovel)
        {
            ...
            if (HelperController.Helper.AtualizarDadoPessoa(morada, numeroTelemovel, "Morada"))
            {
                return Ok("Atualizado com sucesso ");
            }
            else
        ...
        {
               if (HelperController.Helper.AtualizarDadoPessoa(Convert.ToString(numerotelemovelNovo), numeroTelemovelAntigo, "Morada"))
            {
                return Ok("Atualizado com sucesso ");
            }
            else
        ...
        public IActionResult AtualizarTodasInformacoes(
            int NumeroTelemovel,
            string Nome,
            string Morada
        )
        ...
        public IActionResult AdicionarPessoa(string nome, string morada, int NumeroTelemovel)
        {
            ...
            string teste = JsonConvert.SerializeObject(pessoa1);
